...
"""
programmer ทำงาน 3 อย่าง (write, debug, refactor)
refactor code ให้แยกกระบวนการทำงานออกเป็น function
"""
...
phone_numberFlag = True
if len(phone_number) != 10:
    phone_numberFlag = False
else:
...
if ageFlag == True:
    ...
    #print("Age: Invalid (%d years old)" % int(age))
else:
    print("Age: Invalid (less than 18 or more than 65)")

if phone_numberFlag == True:
...
if int(age) >= 18 and int(age) <=30:
    print("Age Group: Young Adult (18-90)")
else:
